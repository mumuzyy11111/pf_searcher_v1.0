...
- 浏览 PF 常见状态规则与关键效果
- 使用人物卡状态记录器维护战斗/冒险状态档案，并让 Buff、专长、职业能力、奇物等自动影响基础数值；状态默认临时保存，可手动保存到浏览器或导出 JSON
- 浏览专长、职业、奇物资料
...
- `assets/js/status-tracker.js`：状态记录器逻辑，支持多角色档案、9 个状态栏位、基础数值总览/可收缩详情栏/摘要列表/右侧编辑栏/来源明细/自动数值影响/多攻击方式/清空本页与状态卡、手动浏览器保存、JSON 导入导出。
